...
def export_portable_library(library_manager) -> list[dict]:
    ...
    for manga in mangas.values():
        ...
        row['reader_profile'] = dict(manga.get('reader_profile') or {})
        row['page_bookmarks'] = list(manga.get('page_bookmarks') or [])
