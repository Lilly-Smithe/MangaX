...
hiddenimports = [
    ...
    *wv_hiddenimports,
    ...
    'mangax.integrations.mal_integration',
    'mangax.integrations.catalog_media',
    'mangax.integrations.mal_sync',
    'mangax.integrations.mal_sync_jobs',
    'mangax.integrations.mal_sync_scheduler',
    'mangax.integrations.mal_outbound',
    'mangax.runtime',
